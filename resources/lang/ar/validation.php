...
return [
    ...
    */
    ...
    'file'                 => 'هذه الخانة :attribute يجب ان تكون ملف.',
    'filled'               => 'هذه الخانة :attribute يجب ان تحتوي على قيمة.',
    'image'                => 'هذه الخانة :attribute يجب ان تكون صورة.',
    'in'                   => 'الخانة المحددة :attribute غير صالحة.',
    'in_array'             => 'خانة :attribute غير موجود في :other.',
    'integer'              => 'هذه الخانة :attribute يجب ان تكون رقم.',
    ...
    'present'              => 'هذه الخانة :attribute يجب ان تحتوي على قيمة.',
    'regex'                => 'تنسيق هذه الخانة :attribute غير صالحة.',
    'required'             => 'هذه الخانة :attribute مطلوبة.',
    ...
    'size'                 => [
        ...
        'string'  => 'هذه الخانة :attribute يجب ان تكون :size حرف.',
        'array'   => 'يجب أن تحتوي خانة :attribute على :size من العناصر.',
    ],
    'string'               => 'هذه الخانة :attribute يجب ان تكون نص.',
    'timezone'             => 'يجب أن تكون خانة :attribute نطاقًا زمنيًا صحيحًا.',
    'unique'               => 'هذه الخانة :attribute مستخدمة بالفعل.',
    'uploaded'             => 'هذه الخانة :attribute فشلت عند تحميلها على النظام.',
    'url'                  => 'تنسيق هذه الخانة :attribute غير صالح.',
    ...
    */
    ...
    'attributes' => [
        'start_date' => 'تاريخ الخضوع',
        'start_date' => 'تاريخ الخضوع',
        'for_month' => 'تاريخ الخضوع',
    ],
