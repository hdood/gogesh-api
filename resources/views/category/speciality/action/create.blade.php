...
@section('content')
    ...
    <div class="card height-auto" data-select2-id="21">
        <div class="card-body" data-select2-id="20">
            ...
            <form class="new-added-form" method="post" action="{{ route('category.speciality.store') }}"
                ...
                <div class="row" data-select2-id="18">
                    ...
                    <div class="col-md-4  form-group">
                        ...
                        <select id="activity_id" name="activity_id" class="select2 select2-hidden-accessible" required>
                            <option value="">Select</option>
                        </select>
                        @error('activity_id')
                            <span class="text-red">{!! $message !!}</span>
