        ...
        <div class="card-body">
            <div class="heading-layout1">
                ...
                @can('category-create', Model::class)
                    <a href="{{ route('category.speciality.create') }}"
                        class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">{{ __('Add Speciality') }}</a>
                @endcan
            ...
            <div class="table-responsive">
                <div class="dataTables_wrapper no-footer">
                    <table class="table table-data table-specialities  display  text-nowrap dataTable no-footer"
                        role="grid" data-url="{{ route('category.speciality.index') }}">
                        <thead>
                            <tr role="row">
                                <th data-name="id"><span>{{ __('ID') }}</span></th>
                                <th data-name="name"><span>{{ __('Name') }}</span></th>
                                <th data-name="activity"><span>{{ __('Activity') }}</span></th>
