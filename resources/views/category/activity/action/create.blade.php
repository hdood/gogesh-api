...
@section('content')
    ...
    <div class="breadcrumbs-area">
        <h3>{{ __('Add Activity') }}</h3>
        <ul>
            <li>
                <a href="{{ route('dashboard') }}">{{ __('home') }}</a>
            </li>
            <li>{{ __('Add Activity') }}</li>
        </ul>
    </div>
    ...
    <div class="card height-auto" data-select2-id="21">
        <div class="card-body" data-select2-id="20">
            ...
            <form class="new-added-form" method="post" action="{{ route('category.activity.store') }}"
                ...
                <div class="row" data-select2-id="18">
                    ...
                    <div class="col-md-4 form-group">
                        <label>{{ __('Code') }} *</label>
                        <input type="text" name="code" placeholder="" class="form-control" value="" required>
                        @error('code')
                            <span class="text-red">{!! $message !!}</span>
                        @enderror
                    </div>
