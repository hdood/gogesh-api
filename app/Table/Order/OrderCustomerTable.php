...
class OrderCustomerTable
{
    ...
    {
        // $data = Order::where('customer_id', $this->request->query('id'))->get();
        // return $data;
    ...
    private function DataTable($data)
    {
        return Datatables::of($data)->addIndexColumn()
            ...
            ->addColumn('action', function ($data) {
                $button = '
                <a class="btn btn-danger btn-sm rounded text-light" id="del" data-url="' . route('order.customer.destroy', $data->id) . '" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="fa fa-trash"></i></a>
              ';
                return $button;
            });
    }
